...
class DataValidation:
    ...
    def get_train_and_test_df(self):
        try:
            train_df = pd.read_excel(self.data_ingestion_artifact.train_file_path, engine= 'openpyxl')
            test_df = pd.read_excel(self.data_ingestion_artifact.test_file_path, engine= 'openpyxl')
            sample_df = pd.read_excel(self.data_ingestion_artifact.sample_file_path, engine= 'openpyxl')
